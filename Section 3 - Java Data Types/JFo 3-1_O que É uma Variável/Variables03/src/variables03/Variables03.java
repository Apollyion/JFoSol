...
public class Variables03 {
    ...
    public static void main(String[] args) {
        ...
        int intVar1 = 1; // O erro era o tipo errado
        int intVar2 = 2;
        int intVar3 = 3; // Faltou declarar o tipo
    
        double doubleVar1, doubleVar2, doubleVar3, doubleVar4;
        doubleVar1 = 1.1;
        doubleVar2 = 2.1; // O nome da variavel tava errado
        doubleVar3 = 3.1; // Tava declarando uma variavel já declarada
        doubleVar4 = 4.1; // Nao tinha atribuido valor para a variavel
    
        String stringVar1 = "1"; // Tava tentando passar um int para uma string
        String stringVar2 = "2";
